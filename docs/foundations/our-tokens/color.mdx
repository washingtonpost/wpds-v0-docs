...
## Usage Guidlines
Our system focuses on being intentional with color and utilizes a monochromatic approach to most UI elements. 
When color is used, it's primary objective is to convey important messaging. Colors can be applied in the following ways:
