---
title: Assets
description: The asset manager is an independent package that allows for more streamlined management of our assets. WPDS-Asset-Manager, also known as WAM, manages all assets as raw SVG files.
---

### Table of contents

- [Getting started](foundations/assets#Getting_started)
- [Design principles](/foundations/assets#Design_principles)
- [Grid and keyline shapes](/foundations/assets#Grid_and_keyline_shapes)
- [Contributing](/foundations/assets#Contributing)
...
<CopyClipboard textToCopy="npm install @washingtonpost/wpds-assets">
  <pre>npm install @washingtonpost/wpds-assets</pre>
</CopyClipboard>
<BR />
