...
thumbnail: public/img/resources/guides/thumbnails/wpds.png
imageTag: public/img/resources/guides/guide_component.png
guideRank: 3
---
...
9. Component documentation lives in [wpds-docs](https://github.com/washingtonpost/wpds-docs). As the main contributor, you are responsible for documenting your new component. Work together with your designer to come up with the content/assets/best practices/etc. you'll need to document. Also, document any implementation details or code specific things in the component README.

10. After documentation is done, the component is ready to be shipped. Review the [release documentation](https://github.com/washingtonpost/wpds-ui-kit/blob/main/docs/RELEASING.md#upload-bundled-code-to-latest-channel) and the [latest release](https://github.com/washingtonpost/wpds-ui-kit/releases) to see how we release components. We release new components on a monthly basis.

11. Now that your work is live others can start to use it! You are expected to commit to two weeks of support and triage. Please review the [support process](https://build.washingtonpost.com/resources/process/support).
