...
Components are released batches but only components with full documentation are fully supported. Any other components taht are released in teh batch without docs will be consider in draft and will be indicated on the doc site as draft. Those will not be fully supported until official release.
