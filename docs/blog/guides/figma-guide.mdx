...
By replacing slots, you can build out a design that does not need to be detached.
...
When modifying the Figma component to apply the desired variant, only use the Figma variant controls. These controls closely match
...
Our plugin resolves this by building a connection to our tokens while still being flexible in Figma.
...
<Container>
  <img width="100%" height="auto" src="/img/guides/figma/border_radius.gif" />
</Container>
