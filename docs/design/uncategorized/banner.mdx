...
<Guide guidance="Don't" className="pa-sm">
...
### Size
The banner will take 100% of its parent container width. The height is determined by the fixed padding, and if it has a [Button icon](../uncategorized/button-icon).
