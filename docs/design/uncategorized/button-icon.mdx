...
<Tabs isDesignDoc={true} relatedUrl="dev/uncategorized/button-icon"/>
...
1. Border
2. Background fill
3. [Icon](../../foundations/our-tokens/icons)
...
### Icon size
All [icon sizes](../../foundations/our-tokens/icons) supported in the button icon.
...
### Color
Button icons follow the same color schemes as our [buttons](./button). To see all color themes see our [color tokens](../../foundations/our-tokens/color).
...
### Icon
Any icon supported in our [Icon tokens](../../foundations/our-tokens/icons) can be used.
...
<!-- Start of a guide -->
### Ambiguous icons
Do not use icons in button icons that leave the user unsure of its action. The button icon should be clear and actionable otherwise a standard [button](./button) should be used.+
